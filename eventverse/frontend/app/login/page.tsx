...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative text-foreground">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(194,122,72,0.18),transparent_25%)]" />
      <motion.div
      ...
      >
        <div className="text-center space-y-2">
          <p className="pill inline-flex px-3 py-1 rounded-full text-xs text-foreground">Welcome back</p>
          <h2 className="text-3xl font-semibold text-foreground">Sign in</h2>
          <p className="text-sm text-muted">Access your saved events and bookings.</p>
        </div>
        ...
        <p className="text-center text-sm text-muted">
          New here?{" "}
          <Link href="/register" className="text-foreground hover:text-foreground/80 font-medium">
            Create an account
          </Link>
        </p>
      </motion.div>
